...
def main():
    path = '../data/echr_dataset/Article8/ngrams_a8_full.csv'
    ...
    casebase_output = 'echr_full_8_casebase.txt'.format(base_name)
    outcomes_output = 'echr_full_8_outcomes.txt'.format(base_name)
