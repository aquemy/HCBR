...
def main():
    path = '../data/echr_dataset/Article8/ngrams_a8_procedure.csv'
    ...
    outcome_file = '../data/echr_dataset/Article8/cases_a8.csv'

    except_features_no_outcomes = []


    final_cases = filter_cases(cases, except_features_no_outcomes)
    final_cases = [o for i, o in enumerate(final_cases) if i not in empty_case]
    casebase_output = 'echr_procedure_8_casebase.txt'.format(base_name)
    outcomes_output = 'echr_procedure_8_outcomes.txt'.format(base_name)

    outcomes = read_cases(outcome_file)
    final_outcomes = filter_cases(outcomes, [0])
    final_outcomes = [o for i, o in enumerate(final_outcomes) if i not in empty_case]
