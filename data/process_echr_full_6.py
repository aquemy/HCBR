...
def main():
    path = '../data/echr_dataset/Article6/ngrams_a6_full.csv'
    ...
    casebase_output = 'echr_full_6_casebase.txt'.format(base_name)
    outcomes_output = 'echr_full_6_outcomes.txt'.format(base_name)
