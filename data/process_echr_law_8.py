...
def main():
    path = '../data/echr_dataset/Article8/ngrams_a8_laws.csv'
    ...
    casebase_output = 'echr_law_8_casebase.txt'.format(base_name)
    outcomes_output = 'echr_law_8_outcomes.txt'.format(base_name)
