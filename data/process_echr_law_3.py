...
def main():
    path = '../data/echr_dataset/Article3/ngrams_a3_law.csv'
    ...
    casebase_output = 'echr_law_3_casebase.txt'.format(base_name)
    outcomes_output = 'echr_law_3_outcomes.txt'.format(base_name)
