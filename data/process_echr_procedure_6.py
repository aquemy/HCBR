...
def main():
    path = '../data/echr_dataset/Article6/ngrams_a6_procedure.csv'
    ...
    casebase_output = 'echr_procedure_6_casebase.txt'.format(base_name)
    outcomes_output = 'echr_procedure_6_outcomes.txt'.format(base_name)
