...
def main():
    path = '../data/echr_dataset/Article6/ngrams_a6_law.csv'
    ...
    casebase_output = 'echr_law_6_casebase.txt'.format(base_name)
    outcomes_output = 'echr_law_6_outcomes.txt'.format(base_name)
